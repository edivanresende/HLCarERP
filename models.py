...
class Veiculo(db.Model):
    ...
    ano_fabricacao = db.Column(
        db.Integer
    )

    ano_modelo = db.Column(
        db.Integer
    )
...
class Produto(db.Model):
    ...
    controla_estoque = db.Column(
        db.Boolean,
        default=True,
        nullable=False
    )

    permite_venda = db.Column(
        db.Boolean,
        default=True,
        nullable=False
    )
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "empresa_id",
            "codigo",
            name="uk_produto_codigo_empresa"
        ),

        UniqueConstraint(
            "empresa_id",
            "codigo_barras",
            name="uk_produto_barra_empresa"
        ),

        Index(
            "idx_produto_descricao",
            "empresa_id",
            "descricao"
        ),
...
class ProdutoFornecedor(db.Model):
    ...
    codigo_fornecedor = db.Column(
        db.String(60)
    )

    ultimo_custo = db.Column(
        Numeric(18,2),
        default=0
    )

    prazo_entrega = db.Column(
        db.Integer,
        default=0
    )

    fornecedor_principal = db.Column(
        db.Boolean,
        default=False
    )
...
class ItemCompra(db.Model):
    ...
    frete_rateado = db.Column(
        Numeric(18,2),
        default=0
    )

    custo_final = db.Column(
        Numeric(18,2),
        default=0
    )
...
class ItemInventario(db.Model):
    ...
    estoque_sistema = db.Column(
        Numeric(18,3),
        default=0
    )

    estoque_contado = db.Column(
        Numeric(18,3),
        default=0
    )
