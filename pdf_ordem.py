...
def gerar_pdf_ordem(ordem):
    ...
    elementos.append(
        Paragraph("<b>DEFEITO RELATADO</b>", normal)
    )

    elementos.append(
        Paragraph(ordem.defeito_relatado or "-", normal)
    )
    ...
    elementos.append(
        Paragraph("<b>DIAGNÓSTICO</b>", normal)
    )

    elementos.append(
        Paragraph(ordem.diagnostico or "-", normal)
    )
    ...
    elementos.append(
        Paragraph("<b>SERVIÇOS EXECUTADOS</b>", normal)
    )

    elementos.append(
        Paragraph(ordem.servico_executado or "-", normal)
    )
    ...
    valores = [
        ...
        ["Serviços", f"R$ {ordem.valor_servicos:.2f}"],

        ["Peças", f"R$ {ordem.valor_pecas:.2f}"],

        ["Desconto", f"R$ {ordem.desconto:.2f}"],

        ["TOTAL", f"R$ {ordem.valor_total:.2f}"],
